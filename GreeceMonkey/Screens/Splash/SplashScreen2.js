...
export default function SplashScreen2({navigation}) {
  return (
    <View style={styles.Container}>
          ...
          <Image 
         source={require('../../assets/images/splash/splash2.jpg')} 
        ...
        <View style={{alignItems:'center',justifyContent:'center',width:width/1.2,top:20}}>
          ...
          <TouchableOpacity style={{justifyContent:'center',alignItems:'center',top:-4}}>
            <Text style={{fontSize:23,fontWeight:'400',color:"#676765" ,left:30}} onPress={()=>navigation.navigate('AccountPage')}>Skip</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{backgroundColor:"#ff6a12",borderRadius:50,height:50,width:50,justifyContent:'center',alignItems:'center'}} onPress={() => navigation.navigate('SplashScreen3')}>
