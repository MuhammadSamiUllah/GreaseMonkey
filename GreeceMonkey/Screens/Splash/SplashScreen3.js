...
export default function SplashScreen3({navigation}) {
  return (
    <View style={styles.Container}>
             ...
             <Image 
            source={require('../../assets/images/splash/splash3.jpg')} 
           ...
           <View style={{alignItems:'center',justifyContent:'center',width:width/1.2,top:20}}>
             ...
             <TouchableOpacity style={{backgroundColor:"#ff6a12",borderRadius:50,height:50,width:50,justifyContent:'center',alignItems:'center'}}  onPress={()=>navigation.navigate('AccountPage')}>
